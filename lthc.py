...
class Parser:
    ...
    def func_def(self):
        ...
        if not self.current_tok.matches(T_KEYWORD, 'FUNC'):
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                "Expected 'FUNC'"
            ))
        ...
        if self.current_tok.type == T_LPAREN:
            ...
            if self.current_tok.type == T_RPAREN:
                ...
                if res.error:
                    return res.failure(InvalidSyntaxError(
                        self.current_tok.pos_start, self.current_tok.pos_end,
                        "Expected ')', 'VAR', 'IF', 'FOR', 'WHILE', 'FUNC', num, identifier, '+', '-', '(' or 'NOT'"
                    ))
    ...
    def atom(self):
        ...
        elif tok.matches(T_KEYWORD, 'FUNC'):
        ...
        return res.failure(InvalidSyntaxError(
            ...
            "Expected num, identifier, '+', '-', '(', 'IF', 'FOR', 'WHILE', 'FUNC'"
        ))
    ...
    def comp_expr(self):
        ...
        if res.error: 
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                "Expected num, identifier, '+', '-' or '(', 'NOT'"
            ))
    ...
    def expr(self):
        ...
        if res.error:
            return res.failure(InvalidSyntaxError(
                self.current_tok.pos_start, self.current_tok.pos_end,
                "Expected 'VAR', 'IF', 'FOR', 'WHILE', 'FUNC', num, identifier, '+', '-' or '('"
            ))
...
global_symbol_table.set("PHI", Number((1+math.sqrt(5))/2))
global_symbol_table.set("E", Number(math.e))
global_symbol_table.set("PI", Number(math.pi))
global_symbol_table.set("TAU", Number(math.tau))
